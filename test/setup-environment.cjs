...
process.env.JWT_ACCESS_KEY_ID ??= 'test-v1';
process.env.JWT_ACCESS_PREVIOUS_KEYS ??= '{}';
...
process.env.AUTH_RATE_LIMIT_IP_MAX ??= '1000';
process.env.AUTH_RATE_LIMIT_WINDOW_SECONDS ??= '60';
process.env.AUTH_PUBLIC_RESPONSE_MIN_MS ??= '50';
