...
export function mapAvailabilitySession(
  ...
  return {
    ...
    localStartsAt: timezone.formatLocalDateTimeAtOffset(record.startsAt, record.utcOffsetMinutes),
    localEndsAt: timezone.formatLocalDateTimeAtOffset(record.endsAt, record.utcEndOffsetMinutes),
    utcOffsetMinutes: record.utcOffsetMinutes,
    utcEndOffsetMinutes: record.utcEndOffsetMinutes,
...
export function mapProviderSession(
  ...
  return {
    ...
    utcEndOffsetMinutes: availability.utcEndOffsetMinutes,
